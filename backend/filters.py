...
Cópia de dashboard/filters.py (decisão de 2026-08-27, ver CLAUDE.md: duas
fontes mantidas em sync manualmente, para não acoplar o backend à pasta
dashboard/). Se a lógica de filtro mudar, replicar dos dois lados.
"""
